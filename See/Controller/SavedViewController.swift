...
// MARK: - Data Source
extension SavedViewController: PagingCollectionViewDataSource{
    ...
    func pagingCollectionView(_ subCollectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.imageView.image = Constant.defaultUIImage()
        cell.loadingIndicator.startAnimating()
        
        if subCollectionView == favoriteCollectionView{
            cell.button.setImage(UIImage(named: Constant.favouriteFill), for: .normal)
            return setupCell(cell, show: favoriteShows[indexPath.row])
            
        }else if subCollectionView == watchlistCollectionView{
            cell.button.setImage(UIImage(named: Constant.bookmarkFill), for: .normal)
...
// MARK: - Delegate
extension SavedViewController: PagingCollectionViewDelegate{
...
// MARK: - FlowLayout
extension SavedViewController: PagingCollectionViewDelegateFlowLayout{
